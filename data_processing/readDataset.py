...
class dataGrabber:
    ...
    def read_csv_files(self):
        ...
        for item in range(len(self.tracks_file_names)):
            # self.tracks_data.append(f"Track {item}")
            ...
            # print ("Tracks file name",self.tracks_file_names)
    ...
    def get_tracks_data(self):
        # tracks_data = tracks_data.drop(['xCenter','yCenter','heading', 
        #           'xAcceleration','yAcceleration','lonVelocity','latVelocity','lonAcceleration','latAcceleration'],axis=1)
